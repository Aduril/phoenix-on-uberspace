...
#
#     PHX_SERVER=true bin/uberphoenix start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :uberphoenix, UberphoenixWeb.Endpoint, server: true
end

if config_env() == :prod do
  config :uberphoenix, Uberphoenix.Repo,
    username: System.get_env() |> Map.get("USER"),
    password:
      System.user_home()
      |> then(&"#{&1}/.pgpass")
      |> File.read!()
  ...
  #
  #     config :uberphoenix, Uberphoenix.Mailer,
