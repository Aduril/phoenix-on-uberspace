defmodule UberphoenixWeb.Router do
  use UberphoenixWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {UberphoenixWeb.LayoutView, :root}
  ...
  scope Application.get_env(:uberphoenix, :uberspace_path), UberphoenixWeb do
    ...
    live "/live-example", ExampleLive
  end

  # Other scopes may use custom stacks.
  # scope "/api", UberphoenixWeb do
  #   pipe_through :api
  # end
